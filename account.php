...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>QUIZZERS</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="Mak.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Md Ayan Khan</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8319363645</h4>
		<h4 style="font-family:'typo' ">ayankhan210751@acropolis.in</h4>
		<h4 style="font-family:'typo' ">Acropolis insitute of management & Technology ,Indore</h4></div></div>
		</p>
      </div>
